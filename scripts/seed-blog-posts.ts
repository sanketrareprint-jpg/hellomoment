/**
 * One-time migration: the blog used to be a hardcoded array in
 * src/lib/blogPosts.ts; it's now stored in the BlogPost table and managed
 * from /admin/blog. This seeds the three original posts so nothing is lost.
