...
// Minimum recharge amount, in rupees. Also enforced server-side in
// /api/wallet/recharge/order and used as the floor for the custom-amount
// field in RechargeOptions.tsx.
